                    ...
                    <div class="cold-md-12">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php  foreach($users as $user): ?>
                                <tr>
                                    <td><?=$user->id;?></td>
                                    <td><img class="admin-user-thumbnail user_img" src="<?php echo $user->image_path_and_placeholder();?>" alt="" width="62" height="62">
                                    </td>

                                    <td><?=$user->username;?>
                                        <div class="actions_links">
                                            <a href="delete_user.php?id=<?php echo $user->id; ?>" class="btn btn-success btn-xs">Delete</a>
