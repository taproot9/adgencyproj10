...
//    echo $date_posted = date("M d Y H:i:s A");
    ...
    if ($new_comment && $new_comment->save()){
        ...
        redirect("photo.php?id={$photo->id}"); //para refresh ra sa page kay mwala ang id inig redirect
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Adgency</a>
        </div>
